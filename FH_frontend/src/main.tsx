...
if (typeof window !== 'undefined') {
  ...
  window.addEventListener('mousemove', initAdSense, { once: true, passive: true });
  window.addEventListener('scroll', initAdSense, { once: true, passive: true });
  window.addEventListener('touchstart', initAdSense, { once: true, passive: true });
  window.addEventListener('keydown', initAdSense, { once: true, passive: true });
}
